...
<div class="container">
	<h3 class="h3">상품목록 </h3>
	<div class="row">
    <c:forEach var = "vo" items="${totalList}">
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="${cp}/detail.do?itemNum=${vo.items_num}">
...
<c:when test="${pre_categoryNum>=1}">
	...
	<c:forEach var="i" begin="${startPageNum}" end="${endPageNum}">
		<a
			href="${cp}/itemSelete?pageNum=${i}&pre_categoryNum=${pre_categoryNum}&main_categoryNum=${main_categoryNum}&selectNum=${selectNum}">
			<span style="">[${i}]</span>
		</a>
	</c:forEach>
	<c:choose>
		<c:when test="${pageCount>endPageNum}">
			<a
				href="${cp}/itemSelete?pageNum=${endPageNum+1}&pre_categoryNum=${pre_categoryNum}&main_categoryNum=${main_categoryNum}&selectNum=${selectNum}">[다음]</a>
		</c:when>
		<c:otherwise>
			다음
		</c:otherwise>
